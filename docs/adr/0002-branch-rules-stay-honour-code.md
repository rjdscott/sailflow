...
- review-01 H-02, which found the false claim, and review-02, which made
  resolving it a precondition for template status. Both were template-repo
  audits and were not carried into this repo.
